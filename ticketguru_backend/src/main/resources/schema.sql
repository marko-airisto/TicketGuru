...
CREATE TABLE AgeLimits (
    ageLimit_ID INTEGER NOT NULL AUTO_INCREMENT,
    name VARCHAR(50) NOT NULL,
    specifier VARCHAR(500) NULL,
    PRIMARY KEY (ageLimit_ID)
);

DROP TABLE IF EXISTS EventOrganizers;
CREATE TABLE EventOrganizers (
    eventOrganizer_ID INTEGER NOT NULL AUTO_INCREMENT,
...
CREATE TABLE EventTickets (
    eventTicket_ID INTEGER NOT NULL AUTO_INCREMENT,
...
CREATE TABLE EventTypes (
    eventType_ID INTEGER NOT NULL AUTO_INCREMENT,
    name VARCHAR(100) NOT NULL,
    info VARCHAR(500) NULL,
...
CREATE TABLE SaleEvents (
    saleEvent_ID INTEGER NOT NULL AUTO_INCREMENT,
    dateTime DATETIME NOT NULL,
    user_ID INT NOT NULL,
    PRIMARY KEY (saleEvent_ID)
);

DROP TABLE IF EXISTS SaleRows;
CREATE TABLE SaleRows (
    saleRow_ID INTEGER NOT NULL AUTO_INCREMENT,
    saleEvent_ID INTEGER NOT NULL,
    ticket_ID INTEGER NOT NULL,
    discount INTEGER NULL,
    PRIMARY KEY (saleRow_ID)
);
...
CREATE TABLE TicketStatuses (
    ticketStatus_ID INTEGER NOT NULL AUTO_INCREMENT,
...
CREATE TABLE TicketTypes (
    ticketType_ID INTEGER NOT NULL AUTO_INCREMENT,
    name VARCHAR(100) NOT NULL,
